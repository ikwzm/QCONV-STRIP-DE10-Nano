...
# | module axi_sample
# | 
set_module_property DESCRIPTION          "Quantized Convolution (strip)"
set_module_property NAME                 qconv_strip_axi
set_module_property VERSION              1.0
set_module_property INTERNAL             false
set_module_property OPAQUE_ADDRESS_MAP   true
set_module_property AUTHOR               "ikwm"
set_module_property DISPLAY_NAME         "qconv_strip_axi"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL    QCONV_STRIP_AXI
add_fileset_file     qconv_strip_axi.vhd        VHDL PATH qconv_strip_axi.vhd

add_fileset          SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VHDL TOP_LEVEL         QCONV_STRIP_AXI
add_fileset_file     qconv_strip_axi.vhd        VHDL PATH qconv_strip_axi.vhd
...
set_parameter_property S_AXI_DATA_WIDTH       DISPLAY_NAME        "Control Status Register I/F Data Width"
set_parameter_property S_AXI_DATA_WIDTH       UNITS               "bits"
set_parameter_property S_AXI_DATA_WIDTH       HDL_PARAMETER       true
set_parameter_property S_AXI_DATA_WIDTH       ALLOWED_RANGES      "32,64,128,256"
...
add_parameter          S_AXI_ID_WIDTH         INTEGER             12
set_parameter_property S_AXI_ID_WIDTH         DEFAULT_VALUE       12
set_parameter_property S_AXI_ID_WIDTH         DISPLAY_NAME        "Control Status Register I/F AXI ID Width"
set_parameter_property S_AXI_ID_WIDTH         TYPE                INTEGER
set_parameter_property S_AXI_ID_WIDTH         UNITS               None
set_parameter_property S_AXI_ID_WIDTH         DESCRIPTION         "Control Status Register I/F AXI ID Width"
set_parameter_property S_AXI_ID_WIDTH         AFFECTS_ELABORATION true
set_parameter_property S_AXI_ID_WIDTH         HDL_PARAMETER       true

add_parameter          IO_AXI_DATA_WIDTH      INTEGER             32
set_parameter_property IO_AXI_DATA_WIDTH      DEFAULT_VALUE       32
...
add_parameter          K_AXI_DATA_WIDTH       INTEGER             32
set_parameter_property K_AXI_DATA_WIDTH       DEFAULT_VALUE       32
...
add_parameter          T_AXI_DATA_WIDTH       INTEGER             32
set_parameter_property T_AXI_DATA_WIDTH       DEFAULT_VALUE       32
...
proc elaborate {} {
    ...
    # +-----------------------------------
    set s_axi_id_width     [ get_parameter_value S_AXI_ID_WIDTH    ]
    set s_axi_data_width   [ get_parameter_value S_AXI_DATA_WIDTH  ]
    set s_axi_addr_width   [ get_parameter_value S_AXI_ADDR_WIDTH  ]
    set s_axi_burst_length 8
    set s_axi_lock_width   1

    add_interface          S     axi4             end
    ...
    add_interface_port     S     S_AXI_AWID     awid     Input  $s_axi_id_width
    add_interface_port     S     S_AXI_AWADDR   awaddr   Input  $s_axi_addr_width
    add_interface_port     S     S_AXI_AWLEN    awlen    Input  $s_axi_burst_length
    add_interface_port     S     S_AXI_AWSIZE   awsize   Input  3
    add_interface_port     S     S_AXI_AWBURST  awburst  Input  2
    ...
    add_interface_port     S     S_AXI_WLAST    wlast    Input  1
    add_interface_port     S     S_AXI_WVALID   wvalid   Input  1
    add_interface_port     S     S_AXI_WREADY   wready   Output 1
    add_interface_port     S     S_AXI_BID      bid      Output $s_axi_id_width
    ...
    add_interface_port     S     S_AXI_ARID     arid     Input  $s_axi_id_width
    add_interface_port     S     S_AXI_ARADDR   araddr   Input  $s_axi_addr_width
    add_interface_port     S     S_AXI_ARLEN    arlen    Input  $s_axi_burst_length
    add_interface_port     S     S_AXI_ARSIZE   arsize   Input  3
    add_interface_port     S     S_AXI_ARBURST  arburst  Input  2
    add_interface_port     S     S_AXI_ARVALID  arvalid  Input  1
    add_interface_port     S     S_AXI_ARREADY  arready  Output 1
    add_interface_port     S     S_AXI_RID      rid      Output $s_axi_id_width
    add_interface_port     S     S_AXI_RDATA    rdata    Output $s_axi_data_width
    add_interface_port     S     S_AXI_RRESP    rresp    Output 2
    add_interface_port     S     S_AXI_RLAST    rlast    Output 1
    ...
    set io_axi_burst_length    8
    set io_axi_lock_width      1

    add_interface          IO    axi4             start
    ...
    add_interface_port     IO    IO_AXI_AWQOS     awqos    Output 4
    add_interface_port     IO    IO_AXI_AWREGION  awregion Output 4
    ...
    add_interface_port     IO    IO_AXI_ARQOS     arqos    Output 4
    add_interface_port     IO    IO_AXI_ARREGION  arregion Output 4
    ...
    set k_axi_burst_length    8
    set k_axi_lock_width      1

    add_interface          K     axi4             start
    ...
    add_interface_port     K     K_AXI_AWQOS      awqos    Output 4
    add_interface_port     K     K_AXI_AWREGION   awregion Output 4
    ...
    add_interface_port     K     K_AXI_ARQOS      arqos    Output 4
    add_interface_port     K     K_AXI_ARREGION   arregion Output 4
    ...
    set t_axi_burst_length    8
    set t_axi_lock_width      1

    add_interface          T     axi4             start
    ...
    add_interface_port     T     T_AXI_AWQOS      awqos    Output 4
    add_interface_port     T     T_AXI_AWREGION   awregion Output 4
    ...
    add_interface_port     T     T_AXI_ARQOS      arqos    Output 4
    add_interface_port     T     T_AXI_ARREGION   arregion Output 4
